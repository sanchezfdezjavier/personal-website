  ...
  return (
    <div className="section-container">
      ...
      <p className="section-text">
        ...
        side-projects and learning new stuff outside of work.
        <br />
        <br />
        ...
        <br />
        <br />
        I'm also blogging in Hashnode, creating TikTok videos and tweeting to
        share my bits of knowledge, and hopefully helping someone out there.
      </p>
    </div>
  );
}
